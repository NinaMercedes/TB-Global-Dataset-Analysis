...
meta_validation <- meta2[-index,]
meta_ml <- meta2[index,]
index2 <- createDataPartition(meta_ml$lineage, time=1, p=0.8, list=FALSE)
meta_testing <- meta2[-index2,]
meta_training <- meta2[index2,]
